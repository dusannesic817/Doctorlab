    ...
    <div class=\"row vh-100\">
      <div class=\"col-lg-3 mt-3 text-center border-end border-secondary-subtle  h-100\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["schedule"]) {
            ...
            <b>";
            // line 22
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["schedule"], "caregiver_data", [], "any", false, false, false, 22), "html", null, true);
            echo "</b>
          </button>
        ";
            ++$context['loop']['index0'];
      ...
      <div class=\"col-lg-9 d-flex align-items-center justify-content-center\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["schedule"]) {
          ...
          <div id=\"card";
            ...
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["schedule"], "photo", [], "any", false, false, false, 53), "html", null, true);
            echo "\" class=\"rounded-circle ms-3 mt-3\" alt=\"...\"
                  style=\"width: 65px; height: 65px; object-fit: cover;\">
                <div class=\"p-2 ms-2 mt-3\">
                  <b class=\"teget\"> Dr. ";
            // line 56
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["schedule"], "doctor_name", [], "any", false, false, false, 56), "html", null, true);
            echo " ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["schedule"], "doctor_surname", [], "any", false, false, false, 56), "html", null, true);
            echo "</b><br> <small>";
...
";
    ...
    {
        return array (  211 => 68,  192 => 63,  178 => 56,  170 => 53,  162 => 48,  158 => 47,  153 => 45,  134 => 44,  120 => 33,  110 => 25,  93 => 22,  88 => 20,  83 => 17,  66 => 16,  55 => 7,  53 => 6,  50 => 5,  46 => 4,  35 => 1,);
    }
