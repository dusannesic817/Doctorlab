...
/* Token/reset.html */
class __TwigTemplate_74c0d660503d692ff868345b8922a684 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("_global/index.html", "Token/reset.html", 1);
...
{% endblock %}
  {% block naslov %}
    Reset
  {% endblock %}
", "Token/reset.html", "C:\\laragon\\www\\doctorlab\\views\\Token\\reset.html");
    }
}
